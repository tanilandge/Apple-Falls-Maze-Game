...
class Player(sprite, pygame.sprite.Sprite):
  def __init__(self, x, y, spriteImg):
      ...
      self.availablePowerUps = [(340, 400), (20,800), (740,80), (740,800)]
      self.score = 0
...
#set up sprites
player = Player(60,120, playerImg)
enemy1 = Enemy(380,440, enemyImg)
enemy2 = Enemy(780,120, enemyImg)
...
class levelTwo():
    ...
    def displayLevelNumber(self):
      font = pygame.font.Font(FONTNAME, 25)
      text = font.render('Level 2',True, LIGHTRED)
    ...
    def mainLoop(self):# Game Loop
      ...
      while not self.done:
        ...
        #Enemy movement
        if timeTaken > 0.45 and powerUpActivated == False:  # Allows enemy to move once every 0.3 seconds as long as as a powerup is not activated
